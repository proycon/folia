...
Radboud University Nijmegen} \AND \addr{Tilburg Centre for Cognition and 
...
Germany\footnote{http://www.sfb632.uni-potsdam.de/}. The format is fairly well
...
Especially notable is the SoNaR corpus \cite{StevinSONAR2013}, the 500 million word reference corpus
for contemporary written Dutch, which is delivered in FoLiA format. Other
corpora in which FoLiA is used are DutchSemCor, a corpus annotated with lexical
semantic senses \cite{DUTCHSEMCOR}; Basilex\footnote{http://www.basilex.nl}, a corpus consisting of elementary
school texts for Dutch; VU-DNC, a diachronic corpus for Dutch.  Several
projects within CLARIN-NL's TTNWW project are also employing FoLiA for their
representational needs. In view of the focus on Dutch in all these projects, it
has to be stressed again that FoLiA in fact is fully language independent.
...
http://proycon.github.io/folia}. Furthermore, a suite called \emph{``FoLiA
tools''}\footnote{http://pypi.python.org/pypi/FoLiA-tools} is
...
\begin{itemize}
 ...
 \item BlackLab\footnote{https://github.com/INL/BlackLab} A corpus retrieval

...
\item \textbf{Parsability \& Efficiency} -- Can the format be parsed and
  ...
  \begin{itemize}
    \item[] We emphasize expressivity over efficiency. That is, efficiency may
...
\item \textbf{Accessibility} - Is the proposed format available freely (open
  ...
  \begin{itemize}
    \item[] This for us is an important dimension that is highly emphasized. Our
...
\begin{itemize}
 ...
 \item FoLiA-stats\footnote{\url{http://tilc.uvt.nl}} - Frequency list generation and n-gram

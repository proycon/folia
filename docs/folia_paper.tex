...
and has extended the format with elements for ``semanticising'' the texts of the
Dutch Acts of Parliament\footnote{E.g. Dutch parliamentary proceedings
1930-2012, semanticised:
...
projects at research group LT3\footnote{\url{http://lt3.hogent.be}} which have
adopted the format.

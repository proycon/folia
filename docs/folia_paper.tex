...
the same standard as the Morpho-syntactic Annotation Framework. \citeasnoun{TEILING} define
...
%\subsection{Other formats} %TODO?

%We compared against two major formats

%\subsection{Potsdamer Austauschformat Linguistischer Annotationen (PAULA)}

%\subsection{Kyoto Annotation Format (KAF)}
...
\begin{itemize}
 ...
 \item Frog\footnote{http://ilk.uvt.nl/frog} - An integration of various memory-based NLP modules developed for
  Dutch. 
 \item Ticcl - Text normalisation  %TODO: Martin? including citation
...
OpenSoNaR. %TODO MArtin: stukje erover? references?

...
the same de jure standard as the Morpho-syntactic Annotation Framework. \citeasnoun{TEILING} define
...
\begin{itemize}
 ...
 \item Frog\footnote{http://ilk.uvt.nl/frog} - An integration of various memory-based NLP modules developed for
  ...
  annotated FoLiA documents. Frog is fully based on FoLiA representations internally.

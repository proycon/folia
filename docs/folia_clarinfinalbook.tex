...
\usepackage{palatino}
%\usepackage{times}  %<- you may want to use this font instead
...
file format accomodating a wide variety of linguistic annotation types,
...
\citeasnoun{FOLIADOC2014} and offers and a reference guide to all elements and attributes
...
\cite{BLACKLAB} (front-end) \cite{WHITELAB} are examples of this. They were %TODO martin: referenties blacklab & whitelab and Whitelab

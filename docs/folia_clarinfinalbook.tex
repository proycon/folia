...
Sloot$^{ac}$, Martin Reynaert$^{ab}$ \and Antal van den Bosch$^c$} %cheating to get the affiliation footnotes right
\date{}
...
FoLiA currently poses one out of various possible solutions.  We claim its
...
hands-on tools and libraries, was in fact a key reason for the creation of

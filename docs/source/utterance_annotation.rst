...
:**Element**: ``<utt>``
:API Class: ``Utterance`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Utterance>`_)
:Required Attributes: 

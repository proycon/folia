...
:**Element**: ``<ref>``
:API Class: ``Reference`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Reference>`_)
:Required Attributes: 

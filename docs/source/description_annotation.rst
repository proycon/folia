...
:**Element**: ``<desc>``
:API Class: ``Description`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Description.html>`_)
:Required Attributes: 

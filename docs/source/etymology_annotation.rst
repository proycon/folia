...
:Declaration: ``<etymology-annotation set="...">`` *(note: set is mandatory)*
:Version History: since v2.5.2
:**Element**: ``<etymology>``
:API Class: ``EtymologyAnnotation`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.EtymologyAnnotation.html>`_)

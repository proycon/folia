...
:**Element**: ``<note>``
:API Class: ``Note`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Note.html>`_)
:Required Attributes: 

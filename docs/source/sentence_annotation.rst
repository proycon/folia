...
:**Element**: ``<s>``
:API Class: ``Sentence`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Sentence.html>`_)
:Required Attributes: 

...
:**Element**: ``<event>``
:API Class: ``Event`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.Event>`_)
:Required Attributes: 

...
.. foliaspec:annotationtype_title(part)
Part Annotation
==================================================================
...
:Declaration: ``<part-annotation set="...">`` *(note: ``set`` is optional for this annotation type)*

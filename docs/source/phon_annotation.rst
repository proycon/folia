...
:**Element**: ``<ph>``
:API Class: ``PhonContent`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.PhonContent.html>`_)
:Required Attributes: 

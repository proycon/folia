...
:Accepted Data: ``<alignment>`` (:ref:`alignment_annotation`), ``<comment>`` (:ref:`comment_annotation`), ``<desc>`` (:ref:`description_annotation`), ``<metric>`` (:ref:`metric_annotation`), ``<su>`` (:ref:`syntax_annotation`)

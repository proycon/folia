...
:**Element**: ``<sense>``
:API Class: ``SenseAnnotation`` (`FoLiApy API Reference <https://foliapy.readthedocs.io/en/latest/_autosummary/folia.main.SenseAnnotation.html>`_)
...
:Valid Context: 
:Feature subsets (extra attributes): * ``synset``

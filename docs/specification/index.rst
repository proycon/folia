...
category of annotation types and provide other mechanisms that allow resource constructors to formalize vocabularu sets.
...
If you want to read more about the motivations behind FoLiA and compare it with other initiatives such as `TEI <http://tei-c.org>`_, LAF .. [LAF] , `TCF <https://weblicht.sfs.uni-tuebingen.de/weblichtwiki/index.php/The_TCF_Format>`_, and
others, then we refer you to our research paper providing a descriptive and comparative study [vanGompel2014]_ .

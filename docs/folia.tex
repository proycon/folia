...
The timing layer is ideally suited for segmenting speech and relating it to a transcription. Precisely for this purpose the timing layer can take an extra attribute \texttt{src}, this attribute specifies the filename or URL of a sound or video file with speech. All begindatetime and enddatetime attributes are then to be interpreted specifically for this file.

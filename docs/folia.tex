...
{\bf \small version 1.4.3 -- Revision 7.2} \\[0.5cm]
{ \Large \bfseries Documentation}\\[0.5cm]
{\large \emph{Maarten van Gompel}}\\[0.5cm]
\HRule \\[1.0cm]

\emph{January 2nd, 2014 \small{(published)} -- August 16th, 2017 \small{(last revision)}} \\[0.3cm]
...
\texttt{format} attribute on each declaration, its valus should be a MIME type.

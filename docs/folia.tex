...
<s xml:id="example.p.1.s.1">
  ...
  <entities>
    <entity xml:id="example.p.1.s.1.entity.1" class="person">
        <wref xml:id="example.p.1.s.1.w.2" t="Dalai" />
        <wref xml:id="example.p.1.s.1.w.3" t="Lama" />
    </entity>
  </entities>
</s>
\end{lstlisting}
    ...
    <su xml:id="example.p.1.s.1.su.1" class="s">     
      <su xml:id="example.p.1.s.1.su.1_1" class="np">
          <su xml:id="example.p.1.s.1.su.1_1_1" class="det">
             <wref xml:id="example.p.1.s.1.w.1" t="The" />       
          </su>
     ...
     <su xml:id="example.p.1.s.1.su.1_2" class="vp"> 
        <su xml:id="example.p.1.s.1.su.1_1_1" class="v">
            <wref xml:id="example.p.1.s.1.w.4" t="greeted" />       
        </su>
        <su xml:id="example.p.1.s.1.su.1_1_2" class="pron">
          <wref xml:id="example.p.1.s.1.w.5" t="him" />       
        </su>
     </su>    
    </su>
  </syntax>
        ...
        <su xml:id="example.p.1.s.1.su.1_1" class="smain">     
            <su xml:id="example.p.1.s.1.su.1_1_1" class="np">     
                <su xml:id="example.p.1.s.1.su.1_1_1_1" class="top">     
                    <wref xml:id="example.p.1.s.1.w.1" t="De" />       
                </su>
                <su xml:id="example.p.1.s.1.su.1_1_1_2" class="top">     
                    <wref xml:id="example.p.1.s.1.w.2" t="man" />
                </su> 
            </su>
            <su xml:id="example.p.1.s.1.su.1_1_2" class="verb">     
                <wref xml:id="example.p.1.s.1.w.3" t="begroette" />   
            </su>
            <su xml:id="example.p.1.s.1.su.1_1_3" class="pron">     
                <wref xml:id="example.p.1.s.1.w.4" t="hem" />   
            </su>
        </su>
        <su xml:id="example.p.1.s.1.su.1_2" class="punct">
            <wref xml:id="example.p.1.s.1.w.5" t="." />               
        </su> 
    </su>
  </syntax>
  <dependencies>
...
<s xml:id="example.p.1.s.1">
  ...
  <chunking>
    ...
    <chunk xml:id="example.p.1.s.1.chunk.3">       
        <wref xml:id="example.p.1.s.1.w.5" t="him" />
        <wref xml:id="example.p.1.s.1.w.6" t="." />
    </chunk>    
  </chunking>
</s>
\end{lstlisting}
  ...
  <altlayers xml:id="example.p.1.s.1.alt.1">
       <chunking annotator="John Doe" 
        ...
        <chunk xml:id="example.p.1.s.1.alt.1.chunk.2">       
            <wref xml:id="example.p.1.s.1.w.2" t="Lama" />                       
            <wref xml:id="example.p.1.s.1.w.4" t="greeted" />
        </chunk>
...
Consider the following two aligned sentences from two \emph{distinct} FoLiA documents in different languages. Note that the \texttt{t} attribute to the \texttt{aref} element is merely optional and is this overhead is added merely to facilitate the job of simple/limited FoLiA parsers.

\begin{lstlisting}[language=xml]
<s xml:id="example-english.p.1.s.1">
  <t>The Dalai Lama greeted him.</t>
  <alignment class="french-translation" target="doc-french.xml">
        <aref xml:id="doc-french.p.1.s.1" t="Le Dalai Lama le saluait." />
  </alignment>
</s>
...
<s xml:id="example-french.p.1.s.1">
  ...
  <alignment class="english-translation" target="doc-english.xml">
        <aref xml:id="doc-english.p.1.s.1" t="The Dalai Lama greeted him." />
  </alignment>
  <alignment class="english-translation" target="doc-dutch.xml">
        <aref xml:id="doc-dutch.p.1.s.1" t="De Dalai Lama begroette hem." />
  </alignment>
</s>
\end{lstlisting}
...
<s xml:id="example-english.p.1.s.1">
  ...
  <complexalignments>
        ...
        <complexalignment class="french-translation" target="doc-french.xml">
            <wref xml:id="example-english.p.1.s.1.w.2" t="Dalai">
            <wref xml:id="example-english.p.1.s.1.w.3" t="Lama">
            <aref xml:id="example-french.p.1.s.1.w.2" t="Dalai">
            <aref xml:id="example-french.p.1.s.1.w.3" t="Lama">
        </complexalignment>
        ...
  </complexalignments>
</s>

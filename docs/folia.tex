...
\status{proposed in v0.9, most parts final in v0.12}{all final parts implemented in pynlpl}
...
\begin{lstlisting}[language=xml]
<annotations>
 <phonetic-annotation set="http://url/to/your/set" />
</annotations>
\end{lstlisting}
\end{declaration}

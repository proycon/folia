...
Optionally, \texttt{X} itself might also be associated with a class, the class in this case would implicitly or explicitly represent all sub-parts, or be the basis upon which redefinement is made.

...
The body contains the to-be-annotated material; more about this later. The gap tags are optional and contain unannotated front matter or back matter that is skipped in annotation. \cite{DCOI}
...
Within the document body, the structure element \texttt{div} can be used to create divisions and subdivisions. They stem from D-Coi and are unmodified in FoLiA. These divisions are not mandatory, but may be used to mark extra structure. D-Coi also supported the elements div0, div1, div2, etc.. As \texttt{div} can be nested at will, this provides no extra function, and thus FoLiA only supports \texttt{div}.

...
\title{FoLiA: Format for Linguistic Annotation \\ \small v0.8 - revision 2}
\author{\emph{Maarten van Gompel} \\ ILK, Tilburg center for Cognition and Communication, Tilburg University \\ Centre for Language Studies, Radboud Universiteit Nijmegen }
...
Further features of the FoLiA format include:

...
\item Link to other internal annotations or to external resources from within any annotation
\end{itemize}
...
well as by its successor, the SoNaR corpus \cite{Oostdijk+08}. Though being
rooted in the D-Coi format, the D-Coi format is very limited. FoLiA instead
introduces a rich generalised framework for linguistic annotation. FoLiA
development started at the ILK research group, Tilburg University, and is
continued at the Centre of Language and Speech Technology of Radboud University
Nijmegen. It is being adopted in multiple projects, primarily in the Dutch and Flemish

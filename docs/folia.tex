...
{\bf \small version 0.11.1 -- Revision 3.8} \\[0.5cm]
{ \Large \bfseries Documentation}\\[0.5cm]
{\large \emph{Maarten van Gompel}}\\[0.5cm]
\HRule \\[1.0cm]

\emph{January 2nd, 2014 \small{(published)} -- July 24th, 2014 \small{(last revision)}} \\[0.3cm] 
...
for such paths, so the slash in the above example is merely a convention. Each

...
Be aware that the span annotation element \texttt{observation} (See
section~\ref{sec:observations}) usually provides a better suited alternative 
for error detection than this \texttt{errordetection} element. The
\texttt{observation} element allows spanning over multiple tokens.

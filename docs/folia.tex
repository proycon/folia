...
{\bf \small version 1.1.0-- Revision 4.4} \\[0.5cm]
{ \Large \bfseries Documentation}\\[0.5cm]
{\large \emph{Maarten van Gompel}}\\[0.5cm]
\HRule \\[1.0cm]

\emph{January 2nd, 2014 \small{(published)} -- April 21st, 2016 \small{(last revision)}} \\[0.3cm] 
...
<metadata type="dc">
  ...
  <foreign-data type="dc" xmlns:dc="http://purl.org/dc/elements/1.1/">
